 ...
 */
function new_page($count,$limit=10,$parameter = array()){
    return new \Org\Nx\Page($count,$limit,$parameter);
}
 ...
 * 判断权限对应按钮/链接等是否显示
 *
 * @param string $rule_name 权限标识
 * @return boolean
 */
function checkAuthShow($rule_name){
